...
* **Automatic RE**: As the research suggests, few generative AI models (GPT 5.5 and Deepseek DeepThink) **can statically reverse engineer the polymorphic decoding algorithm to deobfuscate the encoded strings**.
